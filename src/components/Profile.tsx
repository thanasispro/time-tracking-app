...
const Profile: React.FC<ProfileProps> = ({ activeButton, setActiveButton }) => {
  ...
  return (
    <section className="flex flex-col mt-[81px] md:mt-0 w-full lg:w-[255px] lg:max-h-[520px]">
      <header className="flex flex-row items-center bg-purple-600 gap-6 rounded-[15px] z-10 relative p-[39px_37px_32px_32px] md:py-[34.5px] md:pl-8 lg:flex-col lg:items-start lg:gap-4 lg:pl-[32px] lg:pt-[32px] lg:pr-[85px] lg:pb-[92px] lg:gap-[40px]">
        <img
          ...
          className="rounded-full w-16 h-16 border-white border-4 lg:w-[78px] lg:h-[78px]"
        />
      ...
      <nav className="flex pb-6 pt-12 bg-navy-900 rounded-[15px] -mt-6 z-0 relative md:px-[134px] lg:flex-col lg:gap-2 lg:pb-0 lg:bg-navy-900 lg:rounded-[15px] lg:items-start lg:pl-8 lg:pb-[30px] lg:gap-[21px] lg:-mt-4">
        <button
